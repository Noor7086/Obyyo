        ...
        <div className="col-lg-8 mx-auto">
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-body p-5">
              ...
              <h2 className="fw-bold mb-3">Independent Entity</h2>
              <p>Obyyo is an independent service platform and is entirely unaffiliated with, and not endorsed by, the Multi-State Lottery Association (MUSL) or any official state lottery agency.</p>

              <h2 className="fw-bold mb-3 mt-4">No Guarantee of Winnings</h2>
