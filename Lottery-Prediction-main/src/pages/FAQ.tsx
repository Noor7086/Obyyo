...
const FAQ: React.FC = () => {
  ...
  const faqData = [
    ...
    {
      question: 'How much does access to a prediction cost?',
      answer:
        'We offer flexible pricing starting from $1 per access for individual lottery games. No hidden fees or long-term commitments required.'
    },
    {
