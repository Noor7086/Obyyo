            ...
            <div className="col-lg-8 col-xl-6 text-center">
              <div className="hero-content-new">
                <h1 className="hero-title-new fade-in">
                  Access Advanced Lottery Prediction Technology
                </h1>
                      ...
                      <div className="step-content" style={{ position: 'relative', zIndex: 2 }}>
                        <ul className="list-unstyled mb-0" style={{ fontSize: '0.8rem' }}>
                          ...
                          <li className="mb-0 d-flex align-items-start">
                            ...
                            <span style={{ color: '#374151', lineHeight: '1.4' }}>Receive daily free access to predictions for 7 days</span>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-lg-5 col-md-6">
                    <div className="enhanced-step-item h-100" style={{
                      ...
                      <div className="step-header d-flex align-items-center mb-3" style={{ position: 'relative', zIndex: 2 }}>
                        ...
                        <div>
                          <h5 className="fw-bold mb-1" style={{ color: '#1e293b', fontSize: '1.1rem' }}>Pay-Per-Access</h5>
                  ...
                  <div className="iphone-screen">
                    <div className="how-it-works-slider">
                      ...
                      <div className="how-it-works-slide">
                        ...
                        <div className="slide-title">Get Access</div>
                        <div className="slide-description">Get access to predictions showing non-viable numbers to avoid.</div>
      ...
      <section id="pricing" className="py-5" style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div className="text-center mb-4" style={{ paddingTop: '3rem' }}>
            ...
            <p className="lead text-muted">
              Choose the access plan that fits your needs. No hidden fees, no long-term commitments.
            </p>
          </div>
                ...
                <div className="card-body p-3 text-center">
                  ...
                  <div className="pricing mb-2">
                    ...
                    <div className="d-flex align-items-baseline justify-content-center">
                      ...
                      <span className="text-muted ms-1 small fw-semibold">/Access</span>
                    </div>
                  </div>
