    ...
    if (isInTrial && userSelectedLottery === currentSelectedLottery) {
      ...
      try {
        ...
        if (isAlreadyViewedError) {
          ...
          toast.success('You have already used your daily free access. You can purchase access to view this prediction.');
                                ...
                                {loadingLottery === (lottery.id || lottery.code.toLowerCase()) ? (
                                  ...
                                  <>
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                      <span className="badge bg-primary">${lottery.price}/Access</span>
