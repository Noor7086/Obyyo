  ...
  const nationalLotteries = [
    {
      ...
      numberSelection: "Non-Viable Red and Blue Power balls",
      price: 2,
    ...
    },
    {
      ...
      numberSelection: "Non-Viable Red and Blue Mega balls",
      price: 3,
    ...
    },
    {
      ...
      numberSelection: "Non-Viable Red and Blue Star balls",
      price: 1,
  ...
  const stateLotteries = [
    {
      ...
      numberSelection: "Non-Viable Red balls",
      price: 1,
      lotteryType: "gopher5",
      color: "success"
    }
    ...
    <Card className="h-100 border-0 shadow-custom premium-lottery-card">
      <Card.Body className="p-4 text-center">
        ...
        <div className="mb-4">
          ...
          <small className="text-muted fw-bold text-uppercase opacity-50">PER ACCESS</small>
        </div>
